<?php
    ...
    class DBStub
    {
        ...
        {   
            if($personnummer=="01016522344" && $passord=="KariOlsen65"){
                return "OK";
            }
            return "Feil";
        }
        ...
        {
            if($personnummer==-01016522344){
                return "Feil";
            }
            $konto = new konto();
            $konto->personnummer="010101234567";
            $konto->kontonummer=20516947845;
            $konto->type="Sparekonto";
            $konto->saldo =2300.34;
            $konto->valuta="NOK";
            return $konto;
        ...
        {
            if($kunde->personnummer==-010101234567){
                return "Feil";
            }
            return "OK";
        }
